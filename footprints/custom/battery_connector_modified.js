...
module.exports = {
    ...
    (footprint "ceoloide:battery_connector_jst_ph_2"
        ...
        (fp_line (start -2.8 -0.10) (end -1.8 -0.10) (stroke (width 0.1) (type solid)) (layer "F.SilkS"))
        (fp_line (start 2.8 -0.10) (end 1.8 -0.10) (stroke (width 0.1) (type solid)) (layer "F.SilkS"))
        (fp_line (start 2.3 -0.60) (end 2.3 0.40) (stroke (width 0.1) (type solid)) (layer "F.SilkS"))
        `
        ...
        (fp_line (start -2.8 -0.10) (end -1.8 -0.10) (stroke (width 0.1) (type solid)) (layer "B.SilkS"))
        (fp_line (start 2.8 -0.10) (end 1.8 -0.10) (stroke (width 0.1) (type solid)) (layer "B.SilkS"))
        (fp_line (start 2.3 -0.60) (end 2.3 0.40) (stroke (width 0.1) (type solid)) (layer "B.SilkS"))
